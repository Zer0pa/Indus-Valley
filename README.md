...
<sub>02 · Gnosis Indus Valley animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
...
<div><b>05.3 · BENCHMARKS</b><span>SEARCH TARGET + NMI</span></div>
      <div>
        ...
        <div>
          <div><span>Search</span><span></span><span>PASS</span></div>
          <div><span>NMI</span><span></span><span>PASS</span></div>
          <div><span>Substrate</span><span></span><span>OPEN</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE PERFORMANCE · DEMO FIXTURE</b></div>
      <div>
        <div>
          <div><span>Max query</span><span></span><span>0.0451 ms</span></div>
          <div><span>target</span><span></span><span>100 ms</span></div>
          <div><span>under</span><span></span><span>~2,217&times;</span></div>
          <div><span>NMI</span><span></span><span>0.5793 sigma 5.65</span></div>
        </div>
      </div>
